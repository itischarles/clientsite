<div class="">
    ...
    <form  role="form" action='<?php echo base_url("pensionsave") ?>' method="post">
        ...
        <div class="row">
            ...
            <div class="col-sm-9">
                <div class="form-group col-sm-6">
                    <input type="text" name="pensionProvider" class="form-control">
    ...
    <div class="col-sm-12">
        <div class="row">
            ...
            <div class="col-sm-9">
                <div class="form-group col-sm-6">
                    <input type="text" name="transferReferrence" class="form-control">
    ...
    <div class="col-sm-12">
        <div class="row">
            ...
            <div class="col-sm-9">
                <div class="form-group col-sm-6">
                    <input type="text" name="approximateValue" class="form-control">
